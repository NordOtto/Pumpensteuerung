...
IRRIGATION_WEATHER_CONFIG_FILE = "irrigation_weather_config.json"
IRRIGATION_OVERSEEDING_FILE = "irrigation_overseeding.json"
IRRIGATION_SEQUENTIAL_FILE = "irrigation_sequential.json"
